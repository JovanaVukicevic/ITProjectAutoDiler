...
class PregledOglasa extends React.Component {
    ...
    async componentDidMount() {
        const response = await axios.get("http://localhost:8800/automobil/"+this.state.value.id);
        const response1 =await axios.get("http://localhost:8800/pregledOglasa/"+this.state.value.id);

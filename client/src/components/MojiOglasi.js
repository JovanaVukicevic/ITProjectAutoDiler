...
const userId = d.id;
console.log(userId);
        const response1 = await axios.get("http://localhost:8800/proizvodjac/");
        const response2 = await axios.get("http://localhost:8800/oglasi/");
        const response3 = await axios.get("http://localhost:8800/model/");
        const response4 = await axios.get("http://localhost:8800/model/");
        const response5 = await axios.get("http://localhost:8800/automobil/");
        const response6 = await axios.get("http://localhost:8800/mojiOglasi/"+userId);
        this.setState({
...
async onButtonClick(ID) {
   await  axios.delete("http://localhost:8800/mojiOglasi/ogg/"+ID)
  .then(response => {
      axios.delete("http://localhost:8800/mojiOglasi/"+ID).then(response => {

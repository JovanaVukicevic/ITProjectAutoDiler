...
const userId = d.id;
        ...
        const response2 = await axios.get("http://localhost:8800/model/");
        const response3 = await axios.get("http://localhost:8800/automobil/getmax/gett");
        this.setState({
    ...
    async executeQueryInsert(id){
             ...
             axios.post("http://localhost:8800/dodajOglas/dodaj/oglas/", data1).then(
              (response) => {
    ...
    // let data1={userID:this.state.userID};
      await axios.post("http://localhost:8800/dodajOglas/", data).then(
        (response) => {
          console.log(response.data);

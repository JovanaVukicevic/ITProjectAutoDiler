...
class IzmijeniOglas extends React.Component {
    ...
    async componentDidMount() {
        ...
        const response3=await axios.get("http://localhost:8800/automobil/"+this.state.value.id);
    ...
    onButtonClick = () => {
        ...
        axios.post("http://localhost:8800/dodajOglas/", data).then(
          (response) => {
    ...
    onButtonClick1 =() =>{
        ...
        axios.put("http://localhost:8800/izmijeniOglas/", data)
